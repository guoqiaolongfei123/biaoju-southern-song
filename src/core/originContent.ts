...
export const ORIGINS: Record<OriginId, OriginDefinition> = {
  "linan-guild": {
    ...
    silver: 120, supplies: 14, reputation: 28, jianghuReputation: 12, morale: 72,
  ...
  "xiangyang-veterans": {
    ...
    silver: 82, supplies: 18, reputation: 32, jianghuReputation: 28, morale: 80,
  ...
  "quanzhou-merchants": {
    ...
    silver: 158, supplies: 10, reputation: 24, jianghuReputation: 8, morale: 66,
